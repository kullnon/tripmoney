...
<div style="max-width:560px;margin:0 auto;padding:40px 20px;">
  <div style="background:#0A0F1E;border-radius:16px;overflow:hidden;border:1px solid #1E2D45;">
    <div style="padding:40px 32px;text-align:center;">
      ...
      <a href="https://mytripmoney.com/auth?next=/app" style="display:inline-block;background:#00D4FF;color:#0A0F1E;padding:14px 32px;border-radius:10px;font-size:0.95rem;font-weight:800;text-decoration:none;">
        Start tracking free →
      </a>
    </div>
  </div>
  <div style="text-align:center;padding:24px 0;">
    ...
    <a href="https://mytripmoney.com/api/unsubscribe?email={{EMAIL}}" style="color:#4A5880;font-size:0.75rem;">Unsubscribe</a>
  </div>
</div>
</body>
</html>`;
  ...
  <div style="background:#0A0F1E;border-radius:16px;overflow:hidden;border:1px solid #1E2D45;">
    <div style="padding:40px 32px;">
      ...
      <div style="text-align:center;margin-top:32px;">
        <a href="https://mytripmoney.com/auth?next=/app" style="display:inline-block;background:#00D4FF;color:#0A0F1E;padding:12px 28px;border-radius:10px;font-size:0.9rem;font-weight:800;text-decoration:none;">
          Start tracking free →
        </a>
      </div>
    </div>
